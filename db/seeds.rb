...
Blog.delete_all
Blog.create(id: 1, name: "Omrika", subdomain: "omrikablog")
Blog.create(id: 2, name: "Jeremy", subdomain: "jermblog")
Blog.create(id: 3, name: "Gian", subdomain: "gianblog")
Blog.create(id: 4, name: "Uzo", subdomain: "uzoblog")
Blog.create(id: 5, name: "Ben", subdomain: "benblog")
